...
| `LITELLM_ORCHESTRATOR_MODEL` | `gpt-4o-mini` | Model for the orchestrator layer (routing/planning) |
| `LITELLM_WORKER_MODEL` | `gpt-4o-mini` | Model used by the Deep Agent for all tasks |
